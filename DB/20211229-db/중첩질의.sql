...
(
    ...
    name varchar2(30) not null, -- 이름없는 고객은 없다
    phone_Number varchar2(20) unique -- 전화번호가 없는사람은 있다
);
...
--중첩질의를 이용해서 orders 테이블의 고객명과 책이름을 모두 출력하게 해보시오.
--중첩 질의 써서 푸는 법 -> view랑 연관되기 때문
--customer 테이블과 그리고 book과 orders를 join한 결과물을 다시 서로 join한다.
